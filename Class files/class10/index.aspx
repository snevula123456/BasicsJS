<aspx xmlns="http://www.w3.org/1999/xaspx">
    ...
    <!-- Mirrored from envytheme.com/tf-demo/edusplash/ by HTTrack Website Copier/3.x [XR&CO'2013], Wed, 06 Feb 2019 08:27:07 GMT -->
    <head>
        <!-- Required meta tags -->
        <meta charset="utf-8">
    ...
    <body>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-6">
                        <ul class="top-info-links">
                            <li><i class="icofont-clock-time"></i> 9.00 AM - 5.30 PM</li>
                            <li><i class="icofont-phone-circle"></i> +040-48599449</li>
                        </ul>
                    </div>
        ...
        <nav class="navbar navbar-expand-lg navbar-light edu-navbar header-sticky">
                    ...
                    <ul class="navbar-nav ml-auto">
                         <%--<li>
                           ...
                           <%-- <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item active" href="index-2.html">Home v1</a></li>
                                <li><a class="dropdown-item" href="index-3.html">Home v2</a></li>
                                <li><a class="dropdown-item" href="index-4.html">Home v3</a></li>
                                <li><a class="dropdown-item" href="index-5.html">Home v4</a></li>
                            </ul>
                        </li>--%>
                        <li class="nav-item">
                        ...
                        <%--<li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownAbout">
                                <li><a class="dropdown-item" href="about-us.html">About Us v1</a></li>
                                <li><a class="dropdown-item" href="about-us-2.html">About Us v2</a></li>
                            </ul>
                        </li>--%>
                         <li class="nav-item">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="services.aspx" id="navbarDropdownPages" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                SERVICES
                            </a>
                           ...
                           <li class="nav-item">
                            <a class="nav-link" href="login.aspx">STUDENT LOGIN</a>
                        </li>
                        <%--<li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownEvent" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                Event
                            </a>

                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownEvent">
                                <li><a class="dropdown-item" href="event.html">Event</a></li>
                                <li><a class="dropdown-item" href="single-event.html">Single Event</a></li>
                            </ul>
                        </li>--%>
                       ...
                       <%-- <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownCourses">
                                ...
                                <li><a class="dropdown-item" href="single-courses.html">Single Courses</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownShop">
                                ...
                                <li><a class="dropdown-item" href="shop-with-sidebar.html">Shop With Sidebar</a></li>
                                <li><a class="dropdown-item" href="single-shop.html">Single Shop</a></li>
                                <li><a class="dropdown-item" href="view-cart.html">View Cart</a></li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownBlog">
                                ...
                                <li><a class="dropdown-item" href="blog-with-sidebar.html">Blog With Sidebar</a></li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#searchmodal" data-toggle="modal" data-target="#searchmodal"><i class="icofont-search"></i></a>
                        </li>
                        ...
                        <%--<li class="nav-item cart-item">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownCart">
                                <li>
                                    <a href="#"><img src="assets/img/courses/react.png" alt="React Logo"></a>
                                ...
                                <li>
                                    <a href="#"><img src="assets/img/courses/meteor.png" alt="React Logo"></a>
                                    <div class="description">
                                        <a href="#">Meteor JS Course</a>
                                        <span class="price"><del>$200</del> $199</span>
                                    </div>
                                </li>
                                <li><div class="total">Total: <strong>$398</strong></div></li>
                                <li>
                                    <a href="checkout.html" class="float-left checkout">Checkout</a>
                                    <a href="view-cart.html" class="float-right view-cart">View Cart</a>
                                </li>
                            </ul>
                        </li>--%>
                    </ul>
                    ...
                    <div class="register-form box-content">
                        ...
                        <form>
                            <div class="form-group">
                                <input type="text" class="form-control" id="id_username" placeholder="Student User Name">
                            </div>

                            <div class="form-group">
                                <input type="password" class="form-control" id="id_password" placeholder="Student Password">
                            </div>


                            <div class="form-foot">
                                <button type="submit" class="btn default-btn" id="bt" onclick="validation()">Login</button>
                                <button type="submit" class="btn default-btn"><a href="register.aspx">Register Now</a></button>
                                <p><a href="forgorpassword.aspx">If You Forgot Password?</a></p>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="bottom-footer">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 col-lg-6">
                            <p>© EduSplash 2019, All Rights Reserved by <a href="https://envytheme.com/" target="_blank">EnvyTheme</a></p>
                        </div>
            ...
            function validation(e) {
                    ...
                    if (re1.test(username.value) && re2.test(password.value)) {
                        alert('sucess');
        ...
        <!-- Mirrored from envytheme.com/tf-demo/edusplash/login.html by HTTrack Website Copier/3.x [XR&CO'2013], Wed, 06 Feb 2019 08:28:11 GMT -->
        </aspx>
